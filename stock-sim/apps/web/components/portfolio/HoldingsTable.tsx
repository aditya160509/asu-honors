...
const COLUMNS: GridColumn<HoldingResponse>[] = [
  ...
  { key: "avg_cost_basis", header: "Avg Cost", width: 90, align: "right", format: "price", sortable: true, colorize: false },
  { key: "current_price", header: "Current Price", width: 100, align: "right", format: "price", sortable: true, colorize: false },
