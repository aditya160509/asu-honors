...
const NAV_COMMANDS: NavCommand[] = [
  ...
  { label: "Go to Allocation", href: "/portfolio/allocation", icon: PieChart },
  { label: "Go to Performance", href: "/portfolio/performance", icon: LineChart },
  { label: "Go to Dividends", href: "/portfolio/dividends", icon: Coins },
  { label: "Go to Goals", href: "/portfolio/goals", icon: Target },
  { label: "Go to Watchlists", href: "/portfolio/watchlists", icon: ListChecks },
  { label: "Go to Transactions", href: "/portfolio/transactions", icon: Receipt },
