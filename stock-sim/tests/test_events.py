...
def test_apply_effect_to_drivers_adds_and_decays():
    ...
    result = evt.apply_effect_to_drivers(drivers, profile, severity=100.0, rho=0.1, days_elapsed=0)
...
def test_apply_effect_to_drivers_does_not_mutate_input():
    ...
    evt.apply_effect_to_drivers(drivers, profile, severity=100.0, rho=0.1, days_elapsed=0)
...
def test_apply_effect_to_drivers_decays_with_time():
    fresh = evt.apply_effect_to_drivers(
        {"news_severity": 0.0}, {"news_severity": -1.0}, severity=100.0, rho=0.1, days_elapsed=0
    )
    stale = evt.apply_effect_to_drivers(
        {"news_severity": 0.0}, {"news_severity": -1.0}, severity=100.0, rho=0.1, days_elapsed=10
    )
...
def test_apply_effect_to_factor_scores_clamps_to_100():
    result = evt.apply_effect_to_factor_scores(
        {"moat_score": 50.0}, {"moat_score": 100.0}, severity=100.0, rho=0.0, days_elapsed=0
    )
...
def test_apply_effect_to_factor_scores_scales_by_severity():
    half = evt.apply_effect_to_factor_scores(
        {"moat_score": 50.0}, {"moat_score": 20.0}, severity=50.0, rho=0.0, days_elapsed=0
    )
    full = evt.apply_effect_to_factor_scores(
        {"moat_score": 50.0}, {"moat_score": 20.0}, severity=100.0, rho=0.0, days_elapsed=0
    )
